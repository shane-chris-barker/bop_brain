...
patch_string = "events.publishers.mqtt_publisher.mqtt.Client"
...
class TestMqttPublisher:
    ...
    def test_multiple_publishes_use_same_client(self, mock_mqtt_client):
        ...
        publisher = MqttPublisher(host='localhost', port=1883, topic='test_topic')
        message1 = EventDTO(event_type=EventType.BOP_DANCE)
        message2 = EventDTO(event_type=EventType.BOP_ANGRY)
    ...
    def test_publish_with_different_message_types(self, mock_mqtt_client):
        ...
        message_types = [
            EventDTO(event_type=EventType.BOP_DANCE),
            EventDTO(event_type=EventType.BOP_ANGRY),
            EventDTO(event_type=EventType.BOP_LOVE)
        ]
